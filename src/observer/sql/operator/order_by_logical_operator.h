...
public:
  ...
  const std::vector<Field> &get_orderByColumns() { return orderByColumns_; }

  std::vector<bool> get_sort_info() { return sort_info_; }

  bool get_if_mult_table() { return if_mult_table; }
